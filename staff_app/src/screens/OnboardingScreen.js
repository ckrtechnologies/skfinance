        ...
        try {
          ...
          if (res && res.length > 0) {
            ...
            setForm(f => ({
              ...
              latitude: lat,
              longitude: lng,
              business_address: address.formattedAddress || f.business_address,
              city: address.locality || f.city,
              state: address.adminArea || f.state,
          ...
          <YStack space="$4" key="step1" animation="quick" enterStyle={{ opacity: 0, x: direction * 50 }} exitStyle={{ opacity: 0, x: -direction * 50 }}>
            ...
            <YStack space="$2" p="$4" backgroundColor={colors.brandBlueMuted} borderRadius="$3" borderWidth={1} borderColor={colors.brandBlueLight}>
              ...
              <Paragraph fontSize={12} color={colors.brandBlue}>
                We require your exact location to verify your dealership. Please capture it while at your office.
              </Paragraph>
              ...
              {form.latitude && form.longitude ? (
                <YStack space="$2" mt="$2">
                  ...
                  {!!locationAddress && (
                    <XStack space="$2" ai="flex-start" mt="$1">
                      <MapPin color={colors.textMuted} size={14} mt={2} />
                      <SizableText color={colors.text} fontSize={12} f={1} lineHeight={18}>
                        {locationAddress}
                      </SizableText>
                    </XStack>
                  )}
