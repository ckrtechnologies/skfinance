...
export default function ApplicationDetailsPage({ params }) {
  ...
  return (
    <div style={{ width: '100%', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      {/* Top Header Bar */}
      <div style={{ display: 'flex', itemsAlign: 'center', justifyContent: 'space-between', gap: '16px', paddingBottom: '12px', marginBottom: '16px', borderBottom: '1px solid var(--color-border)' }}>
